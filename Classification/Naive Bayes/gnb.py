# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 17:03:26 2024
...
plt.bar(1,df["is_genuine"].value_counts()[0],label="Real",width=0.5,color="#98a5f9")
plt.bar(2,df["is_genuine"].value_counts()[1],label="Fake",width=0.5,color="#8347fa")
plt.title("Numbers of Real and Fake")
plt.legend()
plt.show()
