# -*- coding: utf-8 -*-
"""
Created on Wed May 29 14:11:28 2024
...
model = sm.OLS(dtr.predict(x_test),y_test)
model.fit().summary()
...
sns.kdeplot(dtr.predict(x_test),linewidth=2,label="Predicted Values",color="#d520ee")
plt.xlabel("Values")
